...
$array = [];
$array [] = \models\Guitars::searchProductsByBrand($searchQuery);
$array [] = \models\Audio::searchProductsByBrand($searchQuery);
$array [] = \models\Keyss::searchProductsByBrand($searchQuery);
$array [] = \models\Bowed::searchProductsByBrand($searchQuery);
$array [] = \models\Drums::searchProductsByBrand($searchQuery);
$array [] = \models\Winds::searchProductsByBrand($searchQuery);
